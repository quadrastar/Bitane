[index.html](https://github.com/user-attachments/files/22326818/index.html)
<!DOCTYPE html>
<html lang="tr">
<head>
<meta charset="UTF-8">
...
<div class="card">
  ...
  <p style="font-size:22px;color: rgba(255,255,255,0.7);">😔</p>
  <div>
    <button class="yesBtn">Evet 💕</button>
    <button id="no">Hayır 🙈</button>
  </div>

  <div id="soNsuza">SoNsuza Dek BotPRe 🐰🐰🐰</div>
</div>
...
// Hayır mesajları, Alistar mı? 3 kez tekrar
const noMessages=[
  "Emin misin? 🤔",
  "Yapma 😡",
  "Kızıyorum 😠",
...
function spawnFloat(char, x, y=null, scale=1){
  ...
  div.style.left = x+'px';
  div.style.top = y!==null? y+'px':'-50px';
...
yesBtn.addEventListener('click',()=>{
  ...
  setTimeout(()=>soNsuza.style.transform='translate(-50%,-50%) scale(1.2)',800);
  setTimeout(()=>soNsuza.style.transform='translate(-50%,-50%) scale(1)',1600);
});
